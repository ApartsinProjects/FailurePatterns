"""CLI: normalize Penmanshiel Status_Penmanshiel_*.csv files."""
...
from src.ingest.penmanshiel import run


def main() -> int:
    src = Path(r"E:/tmp/penmanshiel")
    if not any(src.glob("Status_Penmanshiel_*.csv")):
