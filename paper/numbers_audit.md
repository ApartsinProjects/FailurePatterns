...
Total claims audited: 156. Pass: 156. Mismatch: 0.
...
| 3.7               | Sepsis: 20,336 ICU stays                                             | 20,336       | 20336                                           | PASS        |
| 3.7               | Sepsis: 1,790 septic stays                                           | 1,790        | 1790                                            | PASS        |
| 3.7               | Sepsis: 8.8% prevalence                                              | 0.088        | 0.088                                           | PASS        |
| 6.13              | Sepsis last5 length-matched presence AUROC = 0.573                   | 0.573        | 0.573                                           | PASS        |
| 6.13              | Sepsis last10 length-matched presence AUROC = 0.563                  | 0.563        | 0.563                                           | PASS        |
| 6.13              | Sepsis last5 presence per-split min = 0.556                          | 0.556        | 0.556                                           | PASS        |
| 6.13              | Sepsis last10 presence per-split min = 0.541                         | 0.541        | 0.541                                           | PASS        |
| 6.13              | Sepsis length-matched count AUROC = 0.500 (both horizons)            | 0.500, 0.500 | [0.5, 0.5]                                      | PASS        |
| 6.13              | Sepsis last5 multiplicity increment = +0.003 (null)                  | +0.003       | 0.003                                           | PASS        |
| 6.13              | Sepsis last10 multiplicity increment = +0.002 (null)                 | +0.002       | 0.002                                           | PASS        |
| 6.13              | Sepsis last5 order increment = -0.048                                | -0.048       | -0.048                                          | PASS        |
| 6.13              | Sepsis last10 order increment = -0.041                               | -0.041       | -0.041                                          | PASS        |
| 6.13              | Sepsis order increment negative in 0 of 8 splits (both horizons)     | 0.0, 0.0     | [0.0, 0.0]                                      | PASS        |
| 6.13              | Sepsis full-window presence AUROC in [0.66, 0.73] (24h/last10/last5) | 0.66-0.73    | {'24h': 0.725, 'last10': 0.684, 'last5': 0.664} | PASS        |
| 6.13              | Sepsis raw event-count AUROC in [0.62, 0.70] (24h/last10/last5)      | 0.62-0.70    | {'24h': 0.695, 'last10': 0.649, 'last5': 0.621} | PASS        |
| 6.13              | Sepsis static-encoding matched presence near 0.52 (both horizons)    | ~0.52        | [0.532, 0.522]                                  | PASS        |